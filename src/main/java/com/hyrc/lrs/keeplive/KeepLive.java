...
import com.hyrc.lrs.keeplive.config.ForegroundNotification;
import com.hyrc.lrs.keeplive.config.KeepLiveService;
import com.hyrc.lrs.keeplive.config.NotificationUtils;
import com.hyrc.lrs.keeplive.service.JobHandlerService;
import com.hyrc.lrs.keeplive.service.LocalService;
import com.hyrc.lrs.keeplive.service.RemoteService;
...
public final class KeepLive {
    ...
    public static void stopWork(@NonNull Application application) {
        Intent intent = new Intent(application, JobHandlerService.class);
        ...
        NotificationManager mgr = (NotificationManager) application.getSystemService(Context.NOTIFICATION_SERVICE);
        mgr.cancel(NotificationUtils.id, 1);
