...
import com.hyrc.lrs.keeplive.KeepLive;
import com.hyrc.lrs.keeplive.config.NotificationUtils;
import com.hyrc.lrs.keeplive.receiver.NotificationClickReceiver;
import com.hyrc.lrs.keeplive.utils.ServiceUtils;
...
public final class JobHandlerService extends JobService {
    ...
    public boolean onStartJob(JobParameters jobParameters) {
        if (!ServiceUtils.isServiceRunning(this.getApplicationContext(), "com.hyrc.lrs.keeplive.service.LocalService") || !ServiceUtils.isRunningTaskExist(this.getApplicationContext(), this.getPackageName() + ":remote")) {
            this.startService(this);
        }
